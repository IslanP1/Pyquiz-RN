...
const TelaPontuacaoModulo05 = () => {
    ...
    function buscarRespostas() {
        get(ref(db, `users/${userID}/modulo5/respostaexercicios`))
            .then((snapshot) => {
    ...
    function buscarPontuacao() {
        get(ref(db, `users/${userID}/modulo5/exercicios`))
            .then((snapshot) => {
                const data = snapshot.val()
                ...
                if (data.pontuacao == 10) {
                    ...
                    update(ref(db, `users/${userID}/pontuacaogeral`), {
                        pontuacaomodulo5: data.pontuacao,
                    }).then(() => {
...
export default TelaPontuacaoModulo05
